            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('book/edit/' . $result['book_id']) ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class=" mb-3 row">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="discount" name="discount" value="<?= old('discount', $result['discount']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-5">
                            ...
                            <input type="file" class="form-control <?= $validation->hasError('cover') ? 'is-invalid'  : '' ?>" id="cover" name="cover" onchange="previewImage()" value="<?= old('cover') ?>">
                            <div id="validationServer03Feedback" class="invalid-feedback">
